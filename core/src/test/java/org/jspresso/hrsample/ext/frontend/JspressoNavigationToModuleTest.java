...
public class JspressoNavigationToModuleTest extends FrontTestStartup {
   ...
   *     The test context
   */
  protected void doLoadModule(FrontendTestHelper helper) {

    // load app'
    IFrontendController<RComponent, RIcon, RAction> frontendController = getFrontendController();

    // find module
    FactoryBean<ApplicationContext> refContext = getApplicationContext().getBean(
        ThisApplicationContextFactoryBean.class);
    ...
    Module module = ModuleUtils.findModule(helper.originWorkspaceId, helper.originModuleId,
        FilterableBeanCollectionModule.class, frontendController);
   ...
   *     The expected target parent module name
   * @param expectedTargetModuleI18nName
   *     The expected module name
   */
  protected void doNavigationModuleAction(FrontendTestHelper helper, String expectedTargetParentModule,
   ...
   * @param expectedTargetModuleI18nName
   */
  protected void doNavigateAndCheck(FrontendTestHelper helper, String expectedTargetParentModule,
                                    String expectedTargetModuleI18nName) {
    IFrontendController<RComponent, RIcon, RAction> frontendController = getFrontendController();
